...
namespace BLTAdoptAHero.Actions
{
    ...
    {
        /// <summary>
        /// Replacement for ArmyManagementCalculationModel.GetMobilePartiesToCallToArmy, which
        /// existed in game 1.3.15 but was removed by 1.4.8 with no public equivalent.
        ...
        private static IEnumerable<MobileParty> GetPartiesToCallToArmy(MobileParty leaderParty)
        {
            ...
            // Vanilla's internal logic effectively favored nearby parties; this radius controls
            // how far out we look for "extra" parties to add.
            ...
            if (h.Clan.Kingdom != null)
            {
                ...
                if (settings.AutoCallPartiesOnCreate)
                {
                    var vassalParties = h.Clan.Kingdom.AllParties
                        ...
                        .ToList();
                    var modelParties = GetPartiesToCallToArmy(party)
                        .Where(p => p != null);
