    ...
    public class BLTAdoptAHeroModule : MBSubModuleBase
    {
        ...
        public override void OnMissionBehaviorInitialize(Mission mission)
        {
            try
            {
                ...
                mission.AddMissionBehavior(new BLTRallyBehavior());
                mission.AddMissionBehavior(new BLTBattleEventsBehavior());
            ...
            mission.AddMissionBehavior(new BLTSiegeAssaultBehavior());
        ...
        protected override void OnGameStart(Game game, IGameStarter gameStarterObject)
        {
            ...
            campaignStarter.AddBehavior(new BLTCompanionGrowthBehavior());
                ...
                campaignStarter.AddBehavior(new BLTHiredCompanionBehavior());
